<?php
/**
 * Kohana_Image manipulation support. Allows images to be resized, cropped, etc.
 *
...
abstract class Kohana_Image {
	...
	public function resize($width = NULL, $height = NULL, $master = NULL)
	{
		...
		// self::WIDTH and self::HEIGHT deprecated. You can use it in old projects,
	 ...
	 *     $image->flip(self::VERTICAL);
	 *
	 * @param   integer  direction: self::HORIZONTAL, self::VERTICAL
	 * @return  $this
	 * @uses    self::_do_flip
	 */
